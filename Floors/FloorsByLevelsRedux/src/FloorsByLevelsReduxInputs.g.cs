...
namespace FloorsByLevelsRedux
{
    ...
    public  class FloorsByLevelsReduxInputs : S3Args
    
    {
        [Newtonsoft.Json.JsonConstructor]
        
        public FloorsByLevelsReduxInputs(double @floorSetback, double @floorThickness, string bucketName, string uploadsBucket, Dictionary<string, string> modelInputKeys, string gltfKey, string elementsKey, string ifcKey):
        base(bucketName, uploadsBucket, modelInputKeys, gltfKey, elementsKey, ifcKey)
        {
            var validator = Validator.Instance.GetFirstValidatorForType<FloorsByLevelsReduxInputs>();
            if(validator != null)
            {
