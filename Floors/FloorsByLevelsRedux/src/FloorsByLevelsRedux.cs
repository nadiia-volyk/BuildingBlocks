...
{
    public static class FloorsByLevelsRedux
    {
        /// <summary>
        ...
        public static FloorsByLevelsReduxOutputs Execute(Dictionary<string, Model> inputModels, FloorsByLevelsReduxInputs input)
        {
            ...
            var output = new FloorsByLevelsReduxOutputs(floorArea, floors.Count());
